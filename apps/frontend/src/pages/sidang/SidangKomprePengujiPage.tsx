...
export default function SidangKomprePengujiPage() {
  ...
  const assignMutation = useMutation({
    ...
    onSuccess: async () => {
      ...
      closeDrawer();
      setPageError("");
      setSuccessMessage("Dosen penguji Sidang Kompre berhasil ditetapkan.");
    },
    onError: (error) => {
      setSuccessMessage("");
      setPageError(
    ...
    return (
      <section className="page-stack">
        <div className="alert-error">
          Anda tidak memiliki akses ke halaman assign penguji Sidang Kompre.
        </div>
      </section>
    );
  }
  ...
  return (
    <section className="page-stack">
      <PageHeader
        ...
        title="Assign Penguji Sidang Kompre"
        description="Kelola penugasan dosen penguji untuk Sidang Kompre setelah berkas lengkap."
      />
      ...
      <section className="list-card">
        <div className="table-toolbar master-table-toolbar">
          <div>
            ...
            <p className="muted">
              Assign penguji dapat dilakukan setelah berkas Kompre lengkap.
            </p>
          </div>
      ...
      {selectedSidang ? (
        <div className="crud-drawer-backdrop" role="presentation">
          <aside className="crud-drawer" aria-label="Assign penguji Sidang Kompre">
