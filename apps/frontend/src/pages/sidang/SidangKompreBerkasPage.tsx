...
type KompreKategori = "SIDANG_SOFTCOPY" | "SIDANG_PRESENTASI";
...
function getLatestBerkas(item: SidangItem, kategori: KompreKategori) {
...
export default function SidangKompreBerkasPage() {
  ...
  const uploadMutation = useMutation({
    ...
    onSuccess: async () => {
      ...
      setUploadingKey("");
      setPageError("");
      setSuccessMessage("Berkas Sidang Kompre berhasil diupload.");
    },
    onError: (error) => {
      setUploadingKey("");
      setSuccessMessage("");
    ...
    return (
      <section className="page-stack">
        <div className="alert-error">
          Anda tidak memiliki akses ke halaman berkas Sidang Kompre.
        </div>
      </section>
    );
  }
  ...
  return (
    <section className="page-stack">
      <PageHeader
        ...
        title="Upload Berkas Sidang Kompre"
        description="Mahasiswa mengupload softcopy skripsi dan presentasi untuk proses Sidang Kompre."
      />
      ...
      <section className="list-card">
        <div className="table-toolbar master-table-toolbar">
          <div>
            ...
            <p className="muted">
              Setelah berkas lengkap, koordinator dapat assign penguji Kompre.
            </p>
          </div>
