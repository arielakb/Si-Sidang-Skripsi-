...
function getTempat(item: SidangItem) {
  ...
  return ruangLabel || "Tempat manual / online";
}
...
export default function SidangAkhirJadwalPage() {
  ...
  const filteredRows = useMemo(() => {
    ...
    return sidangRows.filter((item) =>
      ...
      } ${item.status ?? ""} ${item.hasil ?? ""} ${getTempat(item)}`
        .toLowerCase()
        .includes(keyword)
    );
  }, [sidangRows, search]);
  ...
  const createMutation = useMutation({
    ...
    onSuccess: async () => {
      ...
      closeDrawer();
      setPageError("");
      setSuccessMessage("Jadwal Sidang Akhir berhasil dibuat.");
    },
    onError: (error) => {
      setSuccessMessage("");
      setPageError(
        getApiErrorMessage(
          error,
          "Gagal membuat jadwal Sidang Akhir. Pastikan ruang tidak bentrok."
        )
      );
    }
  });
    ...
    return (
      <section className="page-stack">
        <div className="alert-error">
          Anda tidak memiliki akses ke halaman jadwal Sidang Akhir.
        </div>
      </section>
    );
  }
  ...
  return (
    <section className="page-stack">
      <PageHeader
        ...
        description="Buat jadwal pengumuman akhir kelulusan skripsi setelah mahasiswa lolos Sidang Kompre."
      />
      ...
      <section className="list-card">
        <div className="table-toolbar master-table-toolbar">
          <div>
            ...
            <p className="muted">
              Tahap ini digunakan untuk pengumuman akhir: LULUS atau TIDAK LULUS skripsi.
            </p>
          </div>
          ...
          <div className="master-toolbar-actions">
            <input
              ...
              placeholder="Cari judul, mahasiswa, ruang, status..."
            />
          </div>
        </div>
