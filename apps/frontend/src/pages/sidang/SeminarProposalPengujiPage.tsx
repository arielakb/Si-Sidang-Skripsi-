...
export default function SeminarProposalPengujiPage() {
  ...
  const assignMutation = useMutation({
    ...
    onSuccess: async () => {
      ...
      closeDrawer();
      setPageError("");
      setSuccessMessage("Dosen penguji seminar proposal berhasil ditetapkan.");
    },
    onError: (error) => {
      setSuccessMessage("");
      setPageError(
    ...
    return (
      <section className="page-stack">
        <div className="alert-error">
          Anda tidak memiliki akses ke halaman workflow sidang.
        </div>
      </section>
    );
  }
  ...
  return (
    <section className="page-stack">
      <PageHeader
        ...
        title="Assign Penguji Seminar Proposal"
        description="Kelola penugasan dosen penguji untuk setiap attempt seminar proposal."
      />
      ...
      <section className="list-card">
        <div className="table-toolbar master-table-toolbar">
          <div>
            <h2>Daftar Attempt Seminar Proposal</h2>
            <p className="muted">
              Data ini berasal dari workflow sidang baru dan tidak mengubah
              halaman skripsi lama.
            </p>
          </div>
      ...
      {selectedSidang ? (
        <div className="crud-drawer-backdrop" role="presentation">
          <aside className="crud-drawer" aria-label="Assign penguji">
            ...
            <div className="drawer-section">
              ...
              <p className="muted">
                Jumlah minimal penguji divalidasi oleh workflow rule di backend.
              </p>
